...
class AccountSummaryCell: UITableViewCell {
    ...
    static let rowHeigh: CGFloat = 112
    ...
    func setup() {
        ...
        balanceLabel.adjustsFontSizeToFitWidth
        balanceLabel.text = "Some balance"
        
        balanceAmountLabel.translatesAutoresizingMaskIntoConstraints = false
        balanceAmountLabel.font = UIFont.preferredFont(forTextStyle: .body)
        balanceAmountLabel.textAlignment = .right
        balanceAmountLabel.attributedText = makeFormattedBalance(dollars: "XXX.XXXX", cents: "XX")
    ...
    func layout() {
        ...
        NSLayoutConstraint.activate([
            balanceStackView.topAnchor.constraint(equalToSystemSpacingBelow: topAnchor, multiplier: 2),
