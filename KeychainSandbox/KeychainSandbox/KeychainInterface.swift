...
struct KeychainInterface {
    ...
    static func save(password: Data, service: String = "com.my-app.bundle-id", account: String = "username@email.com") throws {
    ...
    static func retrive(service: String = "com.my-app.bundle-id", account: String = "username@email.com") throws -> Data {
        let query: [String: AnyObject] = [
            // kSecAttrService,  kSecAttrAccount, and kSecClass
    ...
    static func update(password: Data, service: String = "com.my-app.bundle-id", account: String = "username@email.com") throws {
        let query: [String: AnyObject] = [
            // kSecAttrService,  kSecAttrAccount, and kSecClass
    ...
    static func delete(service: String = "com.my-app.bundle-id", account: String = "username@email.com") throws {
        let query: [String: AnyObject] = [
            // kSecAttrService,  kSecAttrAccount, and kSecClass
